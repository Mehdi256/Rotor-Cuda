			...
			if (thId == 0) {
				...
				if (rangeDiff2.GetBitLength() < 1) {
				    ...
				    if (display > 0) {
					    ...
					    printf("  ROTOR Random : Range no more %s (End range)\n", rangeEnd.GetBase16().c_str());
				    }
		...
		if (rangeDiff2.GetBitLength() > 10) {
			...
			if (rKeyCount2 == 0) {
				if (display > 0) {
					...
					printf("  ROTOR Random : Private keys random in Range: %s <~> %s (MAX) \n\n", tRangeStart.GetBase16().c_str(), tRangeEnd.GetBase16().c_str());
				}
			}
				...
				if (nbit2 < 1) {
					...
					if (rKey > 0) {
						...
						if (avgGpuKeyRate > 1000000000) {
							...
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [GPU: %.2f Gk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]   ",
									toTimeStr(t1, timeStr),
									rhex.GetBase16().c_str(),
									nbFoundKey,
									completedPerc,
							...
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [GPU: %.2f Mk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]   ",
									toTimeStr(t1, timeStr),
									rhex.GetBase16().c_str(),
									nbFoundKey,
									completedPerc,
					...
					if (rKey > 0) {
						...
						if (avgGpuKeyRate > 1000000000) {
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [CPU %d: %.2f Gk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]    ",
									toTimeStr(t1, timeStr),
									rhex.GetBase16().c_str(),
									nbFoundKey,
									completedPerc,
							...
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [CPU %d: %.2f Mk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]    ",
									toTimeStr(t1, timeStr),
									rhex.GetBase16().c_str(),
									nbFoundKey,
									completedPerc,
					...
					if (nbit2 < 1) {
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [GPU: %.2f Gk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]  ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [GPU: %.2f Mk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [CPU %d: %.2f Gk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [CPU %d: %.2f Mk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
					...
					if (nbit2 < 1) {
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [GPU: %.2f Gk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [GPU: %.2f Mk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [CPU %d: %.2f Gk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [%064s] [F: %d] [C: %lf %%] [CPU %d: %.2f Mk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										rhex.GetBase16().c_str(),
										nbFoundKey,
										completedPerc,
				...
				if (nbit2 < 1) {
					...
					if (rKey > 0) {
						...
						if (avgGpuKeyRate > 1000000000) {
							...
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [F: %d] [C: %lf %%] [GPU: %.2f Gk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]   ",
									toTimeStr(t1, timeStr),
									nbFoundKey,
									completedPerc,
									avgGpuKeyRate / 1000000000.0,
							...
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [F: %d] [C: %lf %%] [GPU: %.2f Mk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]   ",
									toTimeStr(t1, timeStr),
									nbFoundKey,
									completedPerc,
									avgGpuKeyRate / 1000000.0,
					...
					if (rKey > 0) {
						...
						if (avgGpuKeyRate > 1000000000) {
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [F: %d] [C: %lf %%] [CPU %d: %.2f Gk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]    ",
									toTimeStr(t1, timeStr),
									nbFoundKey,
									completedPerc,
									nbit2,
							...
							if (isAlive(params)) {
								memset(timeStr, '\0', 256);
								printf("\r  [%s] [F: %d] [C: %lf %%] [CPU %d: %.2f Mk/s] [T: %s] [Years:%03llu Days:%03llu %02llu:%02llu:%02llu]    ",
									toTimeStr(t1, timeStr),
									nbFoundKey,
									completedPerc,
									nbit2,
					...
					if (nbit2 < 1) {
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [GPU: %.2f Gk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]  ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										avgGpuKeyRate / 1000000000.0,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [GPU: %.2f Mk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										avgGpuKeyRate / 1000000.0,
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [CPU %d: %.2f Gk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										nbit2,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [CPU %d: %.2f Mk/s] [T: %s] [Days:%03llu %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										nbit2,
					...
					if (nbit2 < 1) {
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [GPU: %.2f Gk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										avgGpuKeyRate / 1000000000.0,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [GPU: %.2f Mk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										avgGpuKeyRate / 1000000.0,
						...
						if (rKey > 0) {
							...
							if (avgGpuKeyRate > 1000000000) {
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [CPU %d: %.2f Gk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										nbit2,
								...
								if (isAlive(params)) {
									memset(timeStr, '\0', 256);
									printf("\r  [%s] [F: %d] [C: %lf %%] [CPU %d: %.2f Mk/s] [T: %s] [Time left: %02llu:%02llu:%02llu]   ",
										toTimeStr(t1, timeStr),
										nbFoundKey,
										completedPerc,
										nbit2,
